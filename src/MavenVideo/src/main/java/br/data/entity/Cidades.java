...
@NamedQueries({
    ...
    @NamedQuery(name = "Cidades.findByCodigo", query = "SELECT c FROM Cidades c WHERE c.codigo = :codigo"),
...
public class Cidades implements Serializable {
    ...
    public String toString() {
        return "br.data.entity.Cidades[ codigo=" + codigo + " ]";
    }
